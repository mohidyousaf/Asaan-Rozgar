                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Consumer<InventoryModel>(
                                              builder: (context, model, child) {
                                            turnoverday = model.ratio2;
                                            return Text(num.parse(turnoverday.toStringAsFixed(2)).toString(),
                                              style: TextStyle(
                                                color: Color.fromRGBO(
                                                    11, 71, 109, 1),
                                                fontFamily: "Lato",
...
class InventoryModel extends ChangeNotifier {
  ...
  get items => objects;
  get ratio1 => turnoverratio;
  get ratio2 => turnoverday;
  ...
  getInformation() async {
    ...
    turnoverratio = await DBprovider.db.getTurnoverRatio();
    turnoverday = await DBprovider.db.getTurnoverDay();
